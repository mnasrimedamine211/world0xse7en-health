    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Please describe your symptoms in detail. This is not a substitute
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <textarea
                id="symptoms"
                aria-describedby="symptoms-desc"
            ...
            <Button
              ...
              aria-label="Analyze my symptoms"
            >
              {loading ? (
                <>
        ...
        <div aria-live="polite">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI-powered analysis of your symptoms (Not a substitute for
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <div
                  className={`text-2xl font-bold ${getSeverityColor(analysis.aiResponse?.severity)}`}
                >
              ...
              {analysis.aiResponse?.possibleDiagnosis &&
                analysis.aiResponse.possibleDiagnosis.length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold mb-3">
                      Possible Diagnoses
                    </h3>
                    <div className="space-y-3">
                      {analysis.aiResponse.possibleDiagnosis.map(
                        (diagnosis, index) => (
              ...
              {analysis.aiResponse?.recommendedActions &&
                analysis.aiResponse.recommendedActions.length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold mb-3">
                      Recommended Actions
                    </h3>
                    <ul className="space-y-2">
                      {analysis.aiResponse.recommendedActions.map(
                        (action, index) => (
                          <li
                            key={index}
